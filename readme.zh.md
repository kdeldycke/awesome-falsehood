...
- [文本谬误](https://wiesmann.codiferes.net/wordpress/archives/30296) - 通过实际示例说明 Unicode 规范化、连字、代理对、字符宽度，以及子串操作中的字素簇陷阱.
...
- [每个软件工程师应该了解的搜索知识](https://web.archive.org/web/20221207093031/https://scribe.rip/p/what-every-software-engineer-should-know-about-search-27d1df99f80d) - 一篇关于`实现一个搜索引擎有多难`的很棒的文章.
